...
\begin{solution}
    ...
    \begin{figure}[H]\centering
        \subfigure[Gas (70 mmHg, \ce{N2} Added, Total pressure 600 mmHg)]{
            \includegraphics[scale=0.6]{figure/Gas.png}
        }
        \subfigure[Solution (10\% in \ce{CCl4} for 3800-1300, 10\% in \ce{CS2} for 1300-625, and 10\% in \ce{CCl4} for 625-240 \si{\per\centi\meter}) VS. Solvent]{
            \includegraphics[scale=0.6]{figure/Sol.png}
        }
    \end{figure}
...
\begin{solution}
    ...
    \begin{enumerate}[label=\tbf{(\alph*)}]
        \item 由$\Sigma\to\Pi$要求必须是$\sigma\leftrightarrow\pi$的跃迁,而$g$对称性要求必须是$g\to g$或$u\to u$的跃迁.因此对应于$2\sigma_g\to1\pi_g$或$1\pi_u\to2\sigma_u$.
        ...
        \item 与\tbf{(a)}相似,但是对称性相反,因此对应于$2\sigma_u\to1\pi_g$.
...
\begin{solution}
    ...
    \begin{enumerate}[label=\tbf{(\alph*)}]
        ...
        因此是允许的.
        \item 同样地, 参与跃迁的$n$电子的对称性为$\text{B}_2$或$\text{B}_1$.而$\pi^\ast$轨道的对称性为$\text{B}_1$.在$D_{2\text{h}}$点群中$x$, $y$和$z$分别对应于$\text{B}_{1}$, $\text{B}_{2}$和$\text{A}_{1}$对称性.分别有
        \[\text{B}_2\otimes\text{B}_1\otimes\text{B}_1=\text{B}_2\otimes\text{A}_1=\text{B}_2\nsupset\text{A}_1,\quad\text{B}_1\otimes\text{B}_1\otimes\text{B}_1=\text{A}_1\otimes\text{B}_1=\text{B}_1\nsupset\text{A}_1\]
        \[\text{B}_2\otimes\text{B}_2\otimes\text{B}_1=\text{A}_1\otimes\text{B}_1=\text{B}_1\nsupset\text{A}_1,\quad\text{B}_1\otimes\text{B}_2\otimes\text{B}_1=\text{A}_2\otimes\text{B}_1=\text{B}_2\nsupset\text{A}_1\]
        \[\text{B}_2\otimes\text{A}_1\otimes\text{B}_1=\text{B}_2\otimes\text{A}_1=\text{B}_1\nsupset\text{A}_2,\quad\text{B}_1\otimes\text{A}_1\otimes\text{B}_1=\text{B}_1\otimes\text{B}_1=\text{A}_1\]
        因此跃迁是允许的.
    \end{enumerate}
\end{solution}
\begin{homework}[14.]
