...
\begin{table}[H]\centering
    \begin{tabular}{|c|c|c|c|}\hline
        ...
        \makecell[c]{
            ...
            $(\frac34,\frac14,\frac14)$, $(\frac34,\frac34,\frac14)$\\
            $(\frac14,\frac14,\frac34)$, $(\frac14,\frac34,\frac34)$\\
            $(\frac34,\frac14,\frac34)$, $(\frac34,\frac34,\frac34)$\\
        } &
        \makecell[c]{
            \ce{Ni^2+}\,:\\
            $(0,0,0)$, $(0,0,\frac12)$\\
...
\begin{solution}
    ...
    \[\cos\alpha'=\dfrac{\vec{a}'\cdot\vec{b}'}{a'b'}=\dfrac{-\dfrac{2}{9}\vec{a}^2+\dfrac19\vec{b}^2+\dfrac19\vec{a}\cdot\vec{b}+\dfrac19\vec{c}^2}{\dfrac{1}{3}a^2+\dfrac{1}{9}c^2}=\dfrac{-3a^2+2c^2}{6a^2+2c^2}\]
    于是
...
\end{homework}
\begin{proof}
    当$(hkl)$三者中只有一个为$0$时,问题转化为平面几何问题,此时到平面的距离即在对应二维平面内三角形的高.不妨设$l=0$,则有
    \[d=\dfrac{\frac{a}{h}\cdot\frac{b}{k}}{\sqrt{\left(\frac{a}{h}\right)^2+\left(\frac{b}{k}\right)^2}}=\dfrac{1}{\sqrt{\left(\frac{h}{a}\right)^2+\left(\frac{k}{b}\right)^2}}\]
    于是$\dfrac{1}{d^2}=\dfrac{h^2}{a^2}+\dfrac{k^2}{b^2}=\dfrac{h^2}{a^2}+\dfrac{k^2}{b^2}+\dfrac{l^2}{c^2}$.\\
    当$(hkl)$三者中有两个为$0$时,晶面间距$d$即截坐标轴的截距,同样有$\dfrac{1}{d^2}=\dfrac{h^2}{a^2}+\dfrac{k^2}{b^2}+\dfrac{l^2}{c^2}$.\\
    当$(hkl)$三者全不为$0$时,这一晶面过$\left(\dfrac{a}{h},0,0\right)$, $\left(0,\dfrac{b}{k},0\right)$和$\left(0,0,\dfrac{c}{l}\right)$.设平面的法向量为$\vec{n}$,则有
