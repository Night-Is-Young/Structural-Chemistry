...
做变量代换
\[\rho=\dfrac{2Zr}{na},\quad a=\dfrac{m_e}{\mu}a_0,\quad a_0=\dfrac{4\pi\ep_0\hbar^2}{m_ee^2}\]
\section{多电子原子}
\subsection{轨道近似}
氦原子的定态薛定谔方程为
...
\paragraph{泡利方程}
电场中的薛定谔方程,即泡利方程为
\[\i\hbar\dfrac{\p}{\p t}\psi=\hat{H}\psi,\quad\hat{H}=\dfrac{1}{2m}\left[\symbf\sigma\cdot{\hat{\vec{p}}-e\mat{A}}\right]^2+e\phi\]
其中$\symbf\sigma$是泡利矩阵.根据泡利矩阵的性质有
